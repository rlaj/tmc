...
;(function( win, $, undefined ){
	...
	function createSwipeTable( $table ){
		...
		$prevBtn.add( $nextBtn ).click(function( e ){
			...
			e.preventDefault();
			// measureApp(Metrics.page_section,Metrics.page_title,$(this).attr('title'));
		...
		$table
			...
			.bind( "tablesawcolumns.swipetoggle", function(){
				...
				if(!canAdvance(getPrev()) && !canAdvance(getNext())){
					$prevBtn.addClass(hideBtn);
					$nextBtn.addClass(hideBtn);
				} else {
					$prevBtn.removeClass(hideBtn);
					$nextBtn.removeClass(hideBtn);

					$prevBtn[ canAdvance( getPrev() ) ? "removeClass" : "addClass" ]( disableBtn );
					$nextBtn[ canAdvance( getNext() ) ? "removeClass" : "addClass" ]( disableBtn );
				}
				//!-- end RLL hack
			})
